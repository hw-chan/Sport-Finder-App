function AuthPage() {
  return (
    <div className="flex h-full w-screen flex-col items-center overflow-hidden bg-mobileBackground bg-cover bg-center tablet:bg-tabletBackground desktop:block">
      ...
      <div className="fixed bottom-0 h-8 w-full bg-black text-center text-sm text-white">
        @WeSport 2024
      </div>
    </div>
  );
